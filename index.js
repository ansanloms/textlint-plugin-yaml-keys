...
// deps/npm/yaml.ts
var import_npm_yaml_2_9 = __toESM(require_dist());
...
var walk = (node, currentPath, matchers, lineCounter, collected, source) => {
  ...
  if ((0, import_npm_yaml_2_9.isMap)(node)) {
    for (const pair of node.items) {
      ...
      for (const m of matchers) {
        if (matchesAt(m, newPath)) {
          if ((0, import_npm_yaml_2_9.isScalar)(valueNode) && typeof valueNode.value === "string" && valueNode.range) {
  ...
  } else if ((0, import_npm_yaml_2_9.isSeq)(node)) {
    for (const item of node.items) {
      walk(item, [
        ...currentPath,
        "[]"
  ...
  processor(_ext) {
    ...
    return {
      preProcess: (text, _filePath) => {
        const lineCounter = new import_npm_yaml_2_9.LineCounter();
        const doc = (0, import_npm_yaml_2_9.parseDocument)(text, {
          lineCounter,
